...
#' 
#' @param min_backoff `character` The minimum delay between consecutive deliveries of a 
#'   given message
#' @param max_backoff `character` The maximum delay between consecutive deliveries of a  
#'   given message
#'
...
#' 
#' @family Object functions
RetryPolicy <- function(min_backoff, max_backoff) {
  structure(
    list(minimiumBackoff= min_backoff, maxBackoff = max_backoff),
...
#' @param schema `character` Required
#'
...
#'
#' @param ttl Specifies the 'time-to-live' duration for an associated resource
#'
